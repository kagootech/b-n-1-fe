...
function Checkout() {
  ...
  return (
    <>
      <div className="px-4 pt-6 flex items-center mb-3">
        <Link to="/">
      ...
      >
        ...
        <div className="mt-5">
          <div className="mb-4">
            ...
            <input
              type="text"
              className="border-b border-yellow-400 w-full outline-none text-lg py-3"
        ...
        <div className="shadow-sm rounded overflow-hidden px-4 py-2 flex">
          ...
          <div className="pl-2">
            ...
            <h6 className="font-bold text-yellow-500">Rp {product.price}</h6>
          </div>
        </div>
        ...
        <div className="mt-8">
          <div className="py-3 flex items-center justify-between">
            ...
            <input
              type="text"
              className="border-b border-yellow-400 w-20 outline-none py-3 text-center"
              defaultValue={qty}
